...
} from "./chunk-KGTFMUOM.js";
import {
  require_scheduler
} from "./chunk-CRXOFACA.js";
import {
  require_jsx_runtime
...
function resolve(root, key) {
  ...
  key = chain.pop();
  if (!((_target = target) != null && _target.set)) root = chain.reduce((acc, key2) => acc[key2], root);
  return {
    root,
    key,
    target
...
react-reconciler/cjs/react-reconciler.development.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-27SGT3KO.js.map
